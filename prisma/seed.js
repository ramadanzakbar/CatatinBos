...
async function main() {
  ...
  const transactions = [
    ...
    { type: 'EXPENSE', amount: 450000, category: 'Food', note: 'Makan Malam Resto bersama Tim', source: 'GEMMA_AI', date: daysAgo(16) },
    ...
    { type: 'EXPENSE', amount: 350000, category: 'Food', note: 'Kopi & Snack Co-working Space', source: 'GEMMA_AI', date: daysAgo(9) },
    { type: 'EXPENSE', amount: 180000, category: 'Transport', note: 'Voucher Grab & Gojek', source: 'MANUAL', date: daysAgo(7) },
    { type: 'EXPENSE', amount: 650000, category: 'Food', note: 'Struk Belanja Sayur & Daging Segar', source: 'GEMMA_AI', date: daysAgo(4) },
